                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="blog_box bg-white rounded p-2 mt-3">
                            @if(!empty($blogs->images))
                                <div class="img_blog">
                                    <img src="{{asset('storage/'.$blogs->images)}}" alt="" class="img-fluid rounded mx-auto d-block">
                                </div>
                            @endif
                            <div class="blog_detail rounded m-2 p-4 bg-white">
                                <h4 class="font-weight-bold">{{$blogs->title}}</h4>
                                <p class="mt-3 text-muted">{!!$blogs->contents!!}</p>
